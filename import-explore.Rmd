...
Down to business. The ONS dataset is delivered as OpenOffice .ods spreadsheet. Here's some R for import.
...
Opening and inpecting the .ods file let's us know what we are in for in terms of 
...
```{r read-into-r}
## I set a 'data' folder as a sub-driectory of the working directory
path <- "../data/ONS-GB-roads.ods"
ons.roads <- read_ods(path, sheet = 1, skip = 6)
