...
ons.call <- function(sheet, col_names) { # sheet=vector of sheet numbers; col_names=names as 1st line - T/F
  read_ods(url, sheet = sheet, col_names=TRUE, skip=6)
}

# ons.call <- function(sheet) {
#   read_ods("../data/ONS-GB-roads.ods", sheet = sheet, skip=6)
# }

df <- lapply(c(1), ons.call)
...
* There are 6 lines
two extra Local Authorities were added 
