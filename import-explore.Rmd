...
* Sheets contain different types of road length information. Those sheets with names prefixed "RDL0202a"" contain Motorway, 'A' road, and Minor road data broken down by Local authority. This is the data we're interested in.
...
road.data <- lapply(sheets, ons.call)
