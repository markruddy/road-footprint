...
One of the things that interests me is the urban environment and how we travel around it. I use whatever type of transport seems best - car, bus, train, hovercraft (sadly not hovercraft) - depending on what I have to do and how far I have to go. But I ride a bike and walk most places because they tend to be the most convenient and attractive modes.
...
One aspect of how road design impacts people is the amount of space given over to roads, especially in places where people live. The design of our public space influences so much about society - health, economy, well-being - and road infrastructure is the portion of public space that [frames everything else](https://www.theguardian.com/books/2011/oct/14/jane-jacobs-death-and-life-rereading) [@jacobs:1961aa]. From [car parking](https://aseasyasridingabike.wordpress.com/2012/09/04/the-effect-of-private-car-dependence-on-land-use/) to 

With attempts to push electric vehicles as the solution to pollution and transport sector CO2 emissions, the other [externalities](https://en.wikipedia.org/wiki/Externalities_of_automobiles) associated with motorised transport, of any sort, mustn't be forgotten. Electric cars are just as liable to kill and seriously injure or divide neighbourhoods [@appleyard:1981aa; Figure 1] as petrol-powered ones.

<figure class="align-centre">
  <a href="{{ site.url }}{{ site.baseurl }}/assets/images/geo-science/ois-plot.png"><img src="{{ site.url }}{{ site.baseurl }}/assets/images/general/appleyard-1981-fig3.png" alt="Appleyard et al. (1981). Intra-street social connections with differing traffic volumes."></a>
  <figcaption>Appleyard et al. (1981). Intra-street social connections with differing traffic volumes.</figcaption>
</figure> 
